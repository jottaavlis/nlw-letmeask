...
export function Room() {
    ...
    async function handleSendQuestion(event: FormEvent) {
        ...
        let randomQuestionId = Math.random().toString().substr(2, 8);
        ...
        await database.ref(`rooms/${roomId}/questions/${randomQuestionId}`).set(question)
    ...
    async function handleLikeQuestion(questionId: string, likeId: string | undefined) {
        if (likeId) {
            ...
            let randomLikeId = Math.random().toString().substr(2, 8);

            await database.ref(`rooms/${roomId}/questions/${questionId}/likes/${randomLikeId}`).set({
                authorId: user?.id
            })
        }
    }
